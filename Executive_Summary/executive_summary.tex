...
\newcommand{\thirdcoadvisor}{Dr. River Huang}
...
\begin{figure}[htbp]
    ...
    \caption{SMC output for Nuscale alternative in Poland (geometric mean). Values between 0 and 0.4, peaking lower than 0.1}
...
\begin{figure}[htbp]
    ...
    \caption{SMC output for AP1000 alternative in Poland (geometric mean). Values distributed between 0.1 and 0.6, with no clear peak and tails down to 0.0 and up to 0.8.}
...
This work has been partially supported by the ENEN2plus project (HORIZON-EURATOM-2021-NRT-01-13 101061677) funded by the EU
