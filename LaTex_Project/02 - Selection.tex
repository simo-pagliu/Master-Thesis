...
For this study we have taken into consideration only the northern part of Italy due to the country's fragmented electricity market structure. The north bidding zone is the most energy intensive with an average load of 17.66 $\pm$ 4.35 GW and a significant dependence on imports, which averaged 5.23 $\pm$ 1.67 GW in 2024. Imports therefore account for almost 30\% of its electric demand and cross-border flows show that imports are active 99\% hours of the year. 
