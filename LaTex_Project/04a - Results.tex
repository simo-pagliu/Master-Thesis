...
The sensitivity analysis demonstrates robust ranking patterns across expert configurations. E1's inclusion increases result uncertainty but does not substantially alter core rankings.

\subsection{Rankings}
As discussed in the following section, results depend on the aggregation method applied. The ranking results differ significantly between fully compensatory and partially compensatory methods. Figures~\ref{fig:aggregation_methods_comparison_france}--\ref{fig:nsmc_rankings_po} present the ranking heatmaps produced for each country across the three aggregation methods using \gls{nsmc} with geometric mean aggregation, which the analysis identifies as the more appropriate methodology.

\begin{figure}[htbp]
    \centering
    \subfloat[\gls{sum}]{\includegraphics[width=0.32\linewidth]{Phase3_AllMethods_FR_weighted_sum_20260127_171441_heatmap.pdf}}\hfill
    \subfloat[\gls{geo}]{\includegraphics[width=0.32\linewidth]{Phase3_AllMethods_FR_geometric_mean_20260127_171648_heatmap.pdf}}\hfill
    \subfloat[\gls{har}]{\includegraphics[width=0.32\linewidth]{Phase3_AllMethods_FR_harmonic_mean_20260127_171543_heatmap.pdf}}
