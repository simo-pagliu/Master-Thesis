...
\begin{itemize}
    ...
    \item \textbf{Indicator Database}: List of 35 possible indicators that were considered for the analyisis as explained in Section \ref{sec:brainstorming_indicators}, a python script to help navigate the csv file is also provided (Location: \texttt{01\ -\ Attributes\ Definition/Attribute_DB.csv})
\end{itemize}