...
\subsection{MOX Fuel Compatibility}
...
\textcolor{red}{Expert consultation}
...
\textcolor{red}{Lascks presentation of the attribute}
...
\subsection{Potential Impact on the energy market}
\textcolor{red}{To write}

\subsection{Potential Impact on greenhouse gas emissions}
\textcolor{red}{To write}

\subsection{Waste}
\textcolor{red}{To write}

\subsection{Size - Nominal output power}
\textcolor{red}{To write}

\subsection{Load Following Capabilities}
...
\begin{table}[!hb]
    ...
    \begin{tabularx}{\textwidth}{l X X}
        \toprule
        \textbf{Reactor Model} & \textbf{Load Following Capability $\left[ \frac{\%P_{nom}^2}{min} \right]$} & Data Source \\
        \midrule
