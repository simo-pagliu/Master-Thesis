\textcolor{red}{Da rivedere una volta finito il capitolo sulla metodologia. Una volta finito questo capitolo sul caso studio aggiungi anche spiegazione di come si struttura il resto del case study}
In summary, this study conducts a comparative analysis of six nuclear reactor designs: three Generation III+ reactors (\gls{apr}, \gls{epr}1750, and \gls{ap}) and three \glspl{smr} (\gls{bwrx}, Rolls Royce \gls{smr}, and Nuscale), across four European countries (Italy, France, Poland, and Switzerland). The analysis adopts the point of view of governmental energy policy and planning agencies. The primary objective is to evaluate which reactor design is most suitable for deployment by the mid-2030s within each national context.
To take into account multiple dimensions, \gls{mavt} is employed...

This study does not consider siting as mcda analysis of this type are plentiful in the literature as presented in the literature review (Sec \ref{sec:relevant_studies})\cite{DAMOOM2019110, BASEGMEZ2025105897, ABDULLAH2025105626}


\section{Step 0: Definition of the Study Context}
\label{sec:country_selection}
As previously discussed in Section \ref{sec:european_landscape}, several European nations are actively re-evaluating the role of nuclear power in their energy mixes, making the continent an ideal case study to examine how different environments can influence technology selection. A selection of four countries, among all European countries that are reconsidering nuclear (see Figure \ref{fig:european_nuclear_map}), has been made to balance research interest with practical constraints. The chosen nations: France, Italy, Poland, and Switzerland were deliberately selected to capture a wide range of possible scenarios as detailed in the following analysis.\footnote{Data regarding electricity loads and cross border flows presented in the following paragraphs is sourced from the \gls{entso} Transparency Platform and refers to the year 2024 \cite{ENTSOE_Transparency_2025}. The complete data analysis can be found in the repository, see Appendix \ref{sec:appendix_code}.}

\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.8\textwidth]{imgs/Map_Europe_Nuclear.png}
    \caption{Map of European countries reconsidering nuclear energy.}
...
\section{Definition of the alternatives: Selection of reactor models}
