...
APR+ & S.Korea & \xmark & Manufacturer reports the design is an "indigenous reactor cleared of obstacles to export" \cite{kepcoenc2025}\\
\cmidrule(lr){1-4}
ATMEA & Japan, France & \xmark & It seems that the joint venture between Mithubishi and \gls{edf}/Framatome was abandoned \footnote{Unfortunately, no direct, authoritative sources could be identified to support this claim. The conclusion is deduced from the absence of recent project updates.}\\
\cmidrule(lr){1-4}
...
\cmidrule(lr){1-4}
PRISM & US & \xmark & \gls{ge} states it is a "concept ... currently being put into practice in two reactors: Natrium and ARC-100" \cite{GEV_SFR_2025}.\\
\cmidrule(lr){1-4}
