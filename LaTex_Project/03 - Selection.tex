...
As previously discussed in Section \ref{sec:european_landscape}, several European nations are actively re-evaluating the role of nuclear power in their energy mixes, making the continent an ideal case study to examinie how different environments can influence technology selection. While it is obvious that each national context has unique characteristics, a targeted selection of four countries has been made to balance reasearch interest with practical constraints. The chosen nations: France, Italy, Poland, and Switzerland, were deliberately selected, among European countries that are reconsidering nuclear, to capture a wide range of possible scenarios as detailed in the following analysis.\footnote{Data regarding electricity loads and cross border flows presented in the following paragraphes is sourced from the ENTSO-E Transparency Platform and refers to the year 2024 \cite{ENTSOE_Transparency_2025}. The complete data analysis can be found at \textcolor{red}{ADD LINK !!!!!!!!}}
