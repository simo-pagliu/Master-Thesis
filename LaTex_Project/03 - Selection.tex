...
As previously discussed in Section \ref{sec:european_landscape}, several European nations are actively re-evaluating the role of nuclear power in their energy mixes, making the continent an ideal case study to examine how different environments can influence technology selection. While it is obvious that each national context has unique characteristics, a targeted selection of four countries has been made to balance research interest with practical constraints. The chosen nations: France, Italy, Poland, and Switzerland, were deliberately selected, among all European countries that are reconsidering nuclear (see Figure \ref{fig:european_nuclear_map} for all countries that could have been considered), to capture a wide range of possible scenarios as detailed in the following analysis.\footnote{Data regarding electricity loads and cross border flows presented in the following paragraphs is sourced from the \gls{entso} Transparency Platform and refers to the year 2024 \cite{ENTSOE_Transparency_2025}. The complete data analysis can be found in the repository, see Appendix \ref{sec:appendix_code}.}
...
\subsection{Recap and overview of the case study}
