...
\begin{itemize}
    ...
    \item Data availability: This wouldn't be the case for a professional application but for the purpose of this thesis obtaining data outside of the public domain was deemed unfeasible.
\end{itemize}
