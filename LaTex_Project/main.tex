...
\puttitle{
	...
	coadvisor={Prof. Dr. Russell McKenna, Dr. Peter Burgherr, Dr. River Huang}, % Co-Supervisor name, remove this line if there is none
...
\chapter{Literature Review and Objectives} % Presentation of the study
\input{00 - Literature Review.tex}
\input{00 - Objectives.tex}

\chapter{Preparation} % Pre processing
\input{01 - Selection.tex}
\input{01 - Attributes.tex}

\chapter{Analysis} % Main analysis
\input{02 - Experts.tex}
\input{02 - Weights.tex}
\input{02 - Value Functions.tex}

\chapter{Results} % Post processing
\input{03 - Results.tex}
\input{03 - Discussion.tex}
