...
Based on these ratios and some available data points (See Table \ref{tab:capex-data-sources}) the trapezoidal distributions for each reactor model were constructed (See Table \ref{tab:capex-distributions}).





All financial data has been standardized to 2024 EUR.
